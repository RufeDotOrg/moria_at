...
enum { SDL_SWSURFACE = 0 };             /**< Just here for compatibility */
enum { SDL_PREALLOC = 0x00000001 };     /**< Surface uses preallocated memory */
enum { SDL_RLEACCEL = 0x00000002 };     /**< Surface is RLE encoded */
enum { SDL_DONTFREE = 0x00000004 };     /**< Surface is referenced internally */
enum { SDL_SIMD_ALIGNED = 0x00000008 }; /**< Surface uses aligned memory */
