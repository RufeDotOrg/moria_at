...
static struct attackS attackD[] = {
    ...
    {1, 4, 1, 3},   {1, 4, 1, 4},   {1, 4, 2, 4},   {1, 5, 1, 2},
    ...
    {2, 1, 3, 4},   {2, 1, 4, 6},   {2, 2, 1, 4},   {2, 2, 2, 4},
    ...
    {4, 13, 1, 6},  {5, 1, 2, 6},   {5, 1, 3, 7},   {5, 1, 4, 6},
    ...
    {7, 1, 3, 6},   {7, 2, 1, 3},   {7, 2, 1, 6},   {7, 2, 3, 6},
    ...
    {9, 12, 1, 3},  {10, 2, 1, 6},  {10, 4, 1, 1},  {10, 7, 2, 6},
    ...
    {14, 2, 2, 6},  {14, 2, 3, 4},  {14, 2, 3, 9},  {14, 2, 4, 4},
    ...
    {15, 5, 2, 10}, {15, 5, 2, 12}, {15, 12, 1, 3}, {16, 13, 1, 2},
    ...
    {19, 5, 44, 8}, {19, 5, 46, 8}, {19, 5, 52, 8}, {20, 10, 0, 0},
